    ...
    describe("dispute", function () {
      ...
      describe("max disputes", function () {
        ...
        it("should emit event", async function () {
          ...
          await expect(tx1).to.emit(Claims, "DisputeSettled").withArgs(2, 0, 2, Amount(50));
          await expect(tx2).to.emit(Claims, "DisputeSettled").withArgs(2, 0, 2, Amount(30));
          await expect(tx3).to.emit(Claims, "ProposeSettled").withArgs(2, 0, 2, Amount(10));
        });
      });
    });
  });
